...
const ProductDetailPage = ({ route, navigation }) => {
  ...
  const ErrorData = useSelector(
    (state) => state.productDetailReducer.errorData
  );
  ...
  return (
    ...
    >
      ...
      />
      <View style={ProductDetailPageStyle.topview}>
        <Text style={ProductDetailPageStyle.title}>{ProductData.name}</Text>
        <Text style={ProductDetailPageStyle.category}>Category - Tables</Text>

        <View style={ProductDetailPageStyle.producerRatingView}>
          <View style={ProductDetailPageStyle.producerView}>
            <Text style={ProductDetailPageStyle.producerName}>
              {ProductData.producer}
            </Text>
          </View>
          <View style={ProductDetailPageStyle.ratingView}>
            <Image
      ...
      {/* Middle view */}
      <View style={ProductDetailPageStyle.middleView}>
        <View style={ProductDetailPageStyle.priceShareView}>
          <Text style={ProductDetailPageStyle.price}>
            Rs {ProductData.cost}
          </Text>
          ...
          >
            <Image source={ImgConstant.PROD_SHARE} />
          </TouchableOpacity>
        </View>
      ...
      {/* Bottom View */}
      <View style={ProductDetailPageStyle.bottomView}>
        <TouchableOpacity
          style={ProductDetailPageStyle.buyView}
          onPress={OnClickBuy}
        >
          <Text style={ProductDetailPageStyle.buyText}>Buy Now</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={OnClickRate}
        >
          <Text style={ProductDetailPageStyle.rateText}>Rate Now</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
    //  </SafeAreaView>
