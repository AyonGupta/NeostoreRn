...
const DrawerViewModel = 
{
   GetMenuItems : () => {
       ...
       {title : 'My Cart', id : '2', icon : require ('../../Assets/Images/ic_menu_cart.png'), page : RouteConstant.Cart, badge : ''},
       ...
       {title : 'My Orders', id : '9', icon : require ('../../Assets/Images/ic_menu_order.png'), page : RouteConstant.Order, badge : ''},
